...
# módulo tem várias unidades (validators.py, system_detect.py, ...) que se importam
# por nome de topo entre si -- todas precisam ir pra raiz do .pyz, não só o entrypoint.
cp src/*.py "$BUILD_DIR/"
