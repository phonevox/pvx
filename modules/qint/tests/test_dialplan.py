...
class BuildIncludeLineTest(unittest.TestCase):
    # achado ao vivo, conferido contra os dois installers bash originais (sgp linha
    # 659, ixc linha 615): a linha de include nunca leva aspas -- "#include
    # ixcsoft/phonevox.conf", sem aspas ao redor do path.
